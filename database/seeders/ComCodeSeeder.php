    ...
    public function run(): void
    {
        ...
        $data = [
            ...
            [
                ...
                "code_nm" => "Kelas 10",
                "code_value" => "JENJANG_PENDIDIKAN_TP_04",
                "code_group" => "SEKOLAH_TERAKHIR_TP",
            ],
            [
            ...
            [
                ...
                "code_nm" => "Kelas 7",
                "code_value" => "JENJANG_PENDIDIKAN_TP_03",
                "code_group" => "SEKOLAH_TERAKHIR_TP",
            ],
            [
            ...
            [
                ...
                "code_nm" => "Tingkatan 1, Kls 5",
                "code_value" => "JENJANG_PENDIDIKAN_TP_01",
                "code_group" => "SEKOLAH_TERAKHIR_TP",
            ],
            [
            ...
            [
                ...
                "code_nm" => "Kelas 1",
                "code_value" => "JENJANG_PENDIDIKAN_TP_02",
                "code_group" => "SEKOLAH_TERAKHIR_TP",
            ],
            [
            ...
            [
                ...
                "code_nm" => "JENJANG_PENDIDIKAN_TP_04",
                "code_value" => "SMK",
                "code_group" => "SEKOLAH_TERAKHIR_TP",
            ],
            [
