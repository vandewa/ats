...
class Laporan extends Component
{
    ...
    {
        $this->report = DB::table('ats')->select(DB::raw("DISTINCT region_kec, coalesce(sumber, 'Pendataan Baru) as sumber, com_regions.region_nm, count(ats.id) as jumlah, sum(case when status = true  then 1 else 0 end ) as tervalidasi,
