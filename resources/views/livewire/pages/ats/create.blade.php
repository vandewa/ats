<div class="row">
                        ...
                        <div class="p-4 border rounded">
                            ...
                            <form wire:submit.prevent="simpanData" method="POST">         
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        <div class="col-12">
                                            ...
                                            <select name="" class="form-control" wire:model.lazy="dataAts.jenis_kelamin_tp">
                                    ...
                                    <div class="col-md-3">
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <select name="" class="form-control" wire:model.lazy="dataAts.kawin_tp">
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control select3 dataAts-pendidikan_tp3" wire:model.defer="dataAts.pendidikan_tp">
                                    ...
                                    <div class="col-md-3">
                                        <div class="col-12">
                                            ...
                                            <select name="" class="form-control" wire:model.lazy="dataAts.kelas">
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        <div class="col-12">
                                            ...
                                            <select name="" class="form-control" wire:model.lazy="atsAddres.region_kec">
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-12">
                                            ...
                                            <select name="" class="form-control" wire:model.lazy="atsAddres.region_kel">
                                ...
                                <div class="mb-3 row" @if($halamanCreate) style="display: none;" @endif> 
                                    ...
                                    <div class="col-sm-8">
                                        <select name="" class="form-control" wire:model.lazy="atsPendataans.ats_st">
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-4">
                                        <div class="col-12">
                                            ...
                                            <select name="" class="form-control" wire:model.lazy="atsPendataans.sekolah_tp" >
                                                <option value="">Pilih Data</option>
                                    ...
                                    <div class="col-md-5">
                                        <div class="col-12">
                                            ...
                                            <select name="" class="form-control select3 ats-pendataan-nama_sekolah3"  wire:model.defer="atsPendataans.nama_sekolah">
                                                <option value="">Pilih Data</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="col-12">
                                            <label class="form-label">Kelas</label>
                                            <select name="" class="form-control" wire:model.lazy="atsPendataans.kelas">
                                                <option value="">Pilih Data</option>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="" class="form-control" wire:model.lazy="atsPendataans.alasan_tp">
                                            <option value="">Pilih Data</option>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="" class="form-control" wire:model.lazy="atsPendataans.minat_sekolah_st">
                                            <option value="">Pilih Data</option>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="" class="form-control" wire:model.lazy="atsPendataans.disabilitas_st">
                                            <option value="">Pilih Data</option>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="" class="form-control" wire:model.lazy="atsPendataans.jenis_disabilitas_tp">
                                            <option value="">Pilih Data</option>
    ...
    <script>
        ...
        $(document).on('change','.ats-pendataan-nama_sekolah3',function(){
            @this.set('atsPendataans.nama_sekolah', $(this).val())
        });

        $(document).on('change','.dataAts-pendidikan_tp3',function(){
